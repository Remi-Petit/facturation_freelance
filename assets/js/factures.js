...
/** Ajoute une facture dans le local storage, suite à la validation du formulaire
  **/
function addFacture(){
  var newClient = document.getElementById("inputClient").value;
  var newDateFacturation = document.getElementById("inputDateFacturation").value;
  ...
  newFacture.numFact = newFactureNum;
  newFacture.client = newClient;
  newFacture.dateFacturation = newDateFacturation;
